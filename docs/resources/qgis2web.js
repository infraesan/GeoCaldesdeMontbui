...
map.getView().fit([237871.319254, 5104971.349227, 242747.582260, 5108604.921459], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GeoCaldesdeMontbui</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (16 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'by INFRAESAN.COM';
            }
